...
exports.bayesianService = exports.BayesianService = void 0;
class BayesianService {
     ...
     */
    calculatePostTestProbability(pretestProbability, likelihoodRatio) {
        // Validate inputs
     ...
     */
    calculateBothOutcomes(pretestProbability, lrPositive, lrNegative) {
        return {
     ...
     */
    calculateLikelihoodRatios(sensitivity, specificity) {
     ...
     */
    suggestPretestProbability(clinicalContext) {
     ...
     */
    generateTestRationale(hypothesisName, testName, pretestProb, posttestIfPositive, posttestIfNegative) {
...
Clinical significance: ${this.interpretProbabilityChange(pretestProb, posttestIfPositive, posttestIfNegative)}`;
    ...
    interpretProbabilityChange(pretest, posttestPos, posttestNeg) {
     ...
     */
    recommendTestingTier(currentProbability) {
...
exports.BayesianService = BayesianService;
exports.bayesianService = new BayesianService();
