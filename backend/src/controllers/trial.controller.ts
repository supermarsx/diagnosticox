...
export class TreatmentTrialController {
  ...
  async update(req: AuthRequest, res: Response) {
    try {
      ...
      await this.db.execute(
        `UPDATE treatment_trials SET ${fields.join(', ')} WHERE id = ?`,
        values
      );
...
export const treatmentTrialController = new TreatmentTrialController();
